...
use crate::model::{AccountId, ComponentVersion, Empty, PluginInstallationId, Timestamp, WorkerId};
...
mod tests {
    ...
    use crate::model::{
        AccountId, ComponentId, Empty, PluginInstallationId, Timestamp, WorkerId,
    };
    use std::collections::{BTreeMap, BTreeSet};
    use std::time::Duration;
